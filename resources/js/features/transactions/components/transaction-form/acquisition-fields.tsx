...
export function AcquisitionFields({ data, setData, errors }: AcquisitionFieldsProps) {
  return (
    <div className="space-y-4 p-4 bg-green-50 rounded-lg">
      ...
      <div className="space-y-2">
        <Label htmlFor="counterparty_address">譲受先住所</Label>
        <Textarea
